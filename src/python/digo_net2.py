...
def get_loss(vec1, vec2, lbl, criterion=nn.CosineEmbeddingLoss(margin=0.1)):
...
def add_arguments(parser):
    ...
    parser.add_argument("-s",  "--sample", type=str, choices=['cousins', 'pos_only', 'no_common'],
...
if __name__ == "__main__":
    ...
    net = AttnDecoder(ATTN, 200, 10, go_embedding_weights)
