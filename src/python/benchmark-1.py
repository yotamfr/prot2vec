...
def Motifs(inpt):
    ...
    motif36 = Conv2D(64, (36, 1), data_format='channels_first', padding='same', activation='relu')(motif01)
    motif36 = Reshape((1, -1, 64))(motif36)
    return Concatenate(axis=3)([motif03, motif09, motif18, motif36])


def Features(inpt):
    out = inpt
    out = Conv2D(512, (3, 1216), data_format='channels_first', activation='relu', padding='valid')(out)
    # out = MaxPooling2D((2, 1))(out)
    out = Conv2D(512, (7, 1), data_format='channels_first', activation='relu', padding='valid')(out)
    # out = MaxPooling2D((2, 1))(out)
    # out = Conv2D(128, (3, 1), activation='relu', padding='same')(out)
    # out = Conv2D(128, (3, 1), activation='relu', padding='same')(out)
